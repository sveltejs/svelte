...
You can also write apps in Svelte that compiles to native components by using [https://docs.symbiote-native.dev/](Symbiote Native), which leverages the infrastructure provided by React Native.
