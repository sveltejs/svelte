  ...
  * @param {import('../Component.js').default} component
    ...
    constructor(component, parent, scope, info) {
        ...
        if (this.lets.length > 0) {
            ...
            this.lets.forEach(/** @param {any} l */ (l) => {
        ...
        for (let i = info.children.length - 1; i >= 0; i--) {
            ...
            else if ((child.type === 'Element' || child.type === 'InlineComponent' || child.type === 'Slot') &&
                child.attributes.find(/** @param {any} attribute */ (attribute) => attribute.name === 'slot')) {
                const slot_template = {
                    start: child.start,
                    end: child.end,
                    type: 'SlotTemplate',
