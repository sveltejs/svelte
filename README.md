...
The source code for https://svelte.dev lives in the [sites](https://github.com/sveltejs/sites) folder, with all the documentation right [here](https://github.com/sveltejs/documentation). The site is built with [SvelteKit](https://kit.svelte.dev).
