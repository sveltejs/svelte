...
The source code for https://svelte.dev lives in the [new omnisite repo](https://github.com/sveltejs/svelte.dev). The site is built with [SvelteKit](https://svelte.dev/docs/kit).
