...
* **breaking** Minimum supported `@sveltejs/vite-plugin-svelte` version is now 2.4.1. SvelteKit users can upgrade to 1.20.0 or newer to ensure a compatible version ([#8516](https://github.com/sveltejs/svelte/pull/8516))
...
* **breaking** ([#8516](https://github.com/sveltejs/svelte/pull/8516))
