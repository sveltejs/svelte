...
declare module 'svelte/reactivity' {
	 ...
	 *
	 * */
	export function createReactiveFunction<T>(getSnapshot: () => T, onSubscribe: (update: VoidFn_1) => void | VoidFn_1): () => T;
	type VoidFn_1 = () => void;
	class ReactiveValue<T> {
		
		constructor(fn: () => T, onsubscribe: (update: VoidFn) => void | VoidFn);
		get current(): T;
		#private;
	}
	type VoidFn = () => void;
