declare module '@sveltejs/parse-css' {
	 ...
	 * @param source - CSS source code to parse
	 * */
	...
	export class CSSParseError extends Error {
		/**
		 * @param position - Byte position in the CSS source (start)
		 * @param end - End byte position (defaults to position)
		 */
		constructor(code: CSSParseErrorCode, message: string, position: number, end?: number | undefined);
		
		code: CSSParseErrorCode;
	 ...
	 * Error codes for CSS parsing errors
	 */
	type CSSParseErrorCode = "css_expected_identifier" | "css_empty_declaration" | "css_selector_invalid" | "expected_token" | "unexpected_eof";
