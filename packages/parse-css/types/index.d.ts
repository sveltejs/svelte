...
export class CSSParseError extends Error {
	...
	/** Byte position in the CSS source where the error started */
	position: number;
	/** End byte position (may differ from position for range errors) */
	end: number | undefined;

	constructor(code: CSSParseErrorCode, message: string, position: number, end?: number);
}
