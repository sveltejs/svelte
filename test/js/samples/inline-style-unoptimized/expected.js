...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$set = $$props => {
		if ("style" in $$props) $$invalidate({ i: 0, ret: style = $$props.style });
		if ("key" in $$props) $$invalidate({ i: 1, ret: key = $$props.key });
		if ("value" in $$props) $$invalidate({ i: 2, ret: value = $$props.value });
	};
